    ...
    public static class MoreGUILayout
    {
        ...
        public static GUIStyle Text
        {
            get
            {
                ...
                style.name = "ADOLibText";
                style.fontSize = 30;
                style.normal.textColor = Color.black;
                style.font = RDConstants.data.koreanFont;
                return style;
            }
        }

        /// <summary>
        /// ADOLib selection GUIStyle
        /// </summary>
        public static GUIStyle Selection
        {
            get
            {
                var style = new GUIStyle
                {
                    name = "ADOLibSelection",
                    fontSize = 25,
                    alignment = TextAnchor.MiddleCenter,
                    font = RDConstants.data.koreanFont,
                    normal = {background = SettingsUI.ButtonNotActivated, textColor = Color.black},
                    hover = {background = SettingsUI.ButtonActivated, textColor = Color.black},
                    active = {background = SettingsUI.ButtonActivated, textColor = Color.black}
                };
                return style;
            }
        }
        ...
        /// <summary>
        /// ADOLib selection (Active) GUIStyle
        /// </summary>
        public static GUIStyle SelectionActive
        {
            get
            {
                var style = new GUIStyle
                {
                    name = "ADOLibSelectionActive",
                    fontSize = 25,
                    alignment = TextAnchor.MiddleCenter,
                    font = RDConstants.data.koreanFont,
                    normal = {background = SettingsUI.ButtonActivated, textColor = Color.white}
                };
                return style;
            }
        }
        ...
        public static GUIStyle TextInput
        {
            get
            {
                var style = new GUIStyle
                {
                    name = "ADOLibTextInput",
                    fontSize = 25,
                    alignment = TextAnchor.MiddleLeft,
                    font = RDConstants.data.koreanFont,
                    normal = {background = SettingsUI.BG, textColor = Color.white}
                };
                return style;
            }
        }
        ...
        /// <summary>
        /// Extended version of SelectionGrid in GUILayout.
        /// </summary>
        /// <param name="selected">Index of selected item.</param>
        /// <param name="contents">The contents of the SelectionGrid.</param>
        ...
        {
            style ??= Selection;
            styleActive ??= SelectionActive;
            var select = 0;
            var result = selected;
            if (xCount > 1) GUILayout.BeginHorizontal();
            foreach (var content in contents)
            {
                if (select % xCount == 0 && xCount > 1 && select != 0)
                {
                    GUILayout.EndHorizontal();
                    GUILayout.BeginHorizontal();
                }
                ...
                if (selected == select)
                {
                    GUILayout.Button(content, styleActive, options);
                }
                else
                {
        ...
        /// <summary>
        /// Extended version of Toggle in GUILayout.
        /// </summary>
